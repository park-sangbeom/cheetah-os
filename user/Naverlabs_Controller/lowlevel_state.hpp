...
#ifndef __lowlevel_state_hpp__
#define __lowlevel_state_hpp__

#include <lcm/lcm_coretypes.h>



class lowlevel_state
{
    public:
        float      q[12];
...
int lowlevel_state::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lowlevel_state::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int lowlevel_state::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t lowlevel_state::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* lowlevel_state::getTypeName()
{
    return "lowlevel_state";
}

int lowlevel_state::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lowlevel_state::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int lowlevel_state::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t lowlevel_state::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xf694c633671a3431LL;
